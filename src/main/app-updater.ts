...
export class AppUpdater {
  ...
  async tryUpdate() {
    ...
    try {
      ...
      // Echo Infer Desktop update publishing is not configured yet.
      // Keep automatic update checks disabled by default and avoid polling upstream Chatbox endpoints.
