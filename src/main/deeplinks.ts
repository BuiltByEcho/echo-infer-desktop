...
export function handleDeepLink(mainWindow: BrowserWindow, link: string) {
  ...
  // handle `echo-infer://provider/import?config=`
  ...
  // handle `echo-infer://auth/callback?ticket_id=xxx&status=success`
