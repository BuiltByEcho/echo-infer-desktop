...
export default class MenuBuilder {
  ...
  buildDarwinTemplate(): MenuItemConstructorOptions[] {
    const subMenuAbout: DarwinMenuItemConstructorOptions = {
      label: 'Echo Infer Desktop',
      submenu: [
        {
          label: 'About Echo Infer Desktop',
      ...
      submenu: [
        {
          label: 'Learn More',
          click() {
            shell.openExternal('https://chat.builtbyecho.xyz')
          },
        },
        {
          label: 'Github Repo',
          click() {
            shell.openExternal('https://github.com/BuiltByEcho/echo-infer-desktop')
          },
        },
        // {
        ...
        // },
        {
          label: 'Search Issues',
          click() {
            shell.openExternal('https://github.com/BuiltByEcho/echo-infer-desktop/issues?q=is%3Aissue')
          },
        },
      ],
    }
