...
export const AssistantAvatar: FC<AssistantAvatarProps> = ({
  ...
  const isEchoGuideAvatar =
    !avatarKey && !picUrl && !defaultAssistantAvatarKey && sessionType === 'guide' && type !== 'chat'
  return (
    <Avatar
      size={realSize}
      ...
      src={!avatarKey ? picUrl || (isEchoGuideAvatar ? echoInferIcon : undefined) : undefined}
      alt={isEchoGuideAvatar ? 'Echo Infer assistant logo' : undefined}
      bg={
    ...
    >
      {avatarKey ? (
        ...
        ) : isEchoGuideAvatar ? null : sessionType === 'picture' ? (
          type === 'chat' ? (
