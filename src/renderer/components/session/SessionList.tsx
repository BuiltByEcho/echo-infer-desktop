...
import { HIDDEN_ECHO_INFER_BUILTIN_SESSION_IDS } from '@/packages/initial_data'
...
export default function SessionList(props: Props) {
  ...
  const visibleSessions = useMemo(
    () =>
      featureFlags.echoBrandedShell
        ? sortedSessions?.filter((session) => !HIDDEN_ECHO_INFER_BUILTIN_SESSION_IDS.has(session.id))
        : sortedSessions,
    [sortedSessions]
  )
