...
function GuidePage() {
  ...
  return (
    <Stack h="100%" gap={0} className="bg-chatbox-background-primary">
      ...
      <Box px="md" py="sm" maw={860} mx="auto" w="100%" className="flex-none">
        <Box
          data-testid="echo-infer-guide-hero"
          className="overflow-hidden rounded-xl"
          style={{
            backgroundImage: `linear-gradient(90deg, rgba(2, 7, 25, 0.98) 0%, rgba(2, 7, 25, 0.86) 58%, rgba(2, 7, 25, 0.58) 100%), url(${echoBanner})`,
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            border: '1px solid rgba(103, 241, 255, 0.24)',
            boxShadow: '0 18px 52px rgba(0, 0, 0, 0.12)',
          }}
        >
          <Flex align="center" gap="md" p="md">
            <Box
              ...
              style={{
                ...
                borderRadius: 20,
                background: '#020719',
                border: '1px solid rgba(103, 241, 255, 0.5)',
                boxShadow: '0 0 30px rgba(103, 241, 255, 0.2)',
                overflow: 'hidden',
              }}
            >
              <Image src={echoInferIcon} alt="Echo Infer logo" w={58} h={58} fit="contain" />
            </Box>
            <Stack gap={3} className="min-w-0">
              <Text c="white" fw={850} size="xl" lh={1.05} style={{ letterSpacing: '-0.035em' }}>
                Echo Infer Desktop
              </Text>
              <Text size="sm" fw={800}>
                <Box
                  ...
                  style={{
                    color: '#67f1ff',
                    background: 'rgba(2, 7, 25, 0.68)',
                    border: '1px solid rgba(103, 241, 255, 0.22)',
                    borderRadius: 999,
                    padding: '2px 8px',
                    textShadow: '0 0 18px rgba(103, 241, 255, 0.48)',
                  }}
                >
                  Built by Echo · Shipped for private builders
                </Box>
              </Text>
              <Text size="xs" c="gray.3" maw={520}>
                Private AI chat for your existing Echo Infer API key and the echo-private model.
              </Text>
            </Stack>
          </Flex>
        </Box>
              ...
              <Menu position="top-end" shadow="md" transitionProps={{ transition: 'fade-up', duration: 200 }}>
                <Menu.Target>
                  <UnstyledButton className="flex items-center gap-1 px-2 py-1 rounded-lg hover:bg-[var(--chatbox-background-tertiary)] transition-colors">
                    <ProviderImageIcon provider="echo-infer" providerName="Echo Infer Guide" size={18} />
                    <Text size="sm" className="text-[var(--chatbox-tint-secondary)]">
                      Echo Infer Guide
                    </Text>
                    <ScalableIcon
                ...
                <Menu.Dropdown>
                  <Menu.Item
                    leftSection={<ProviderImageIcon provider="echo-infer" providerName="Echo Infer Guide" size={16} />}
