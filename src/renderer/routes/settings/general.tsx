      ...
      <Stack gap="md">
        <Stack gap="xxs">
          ...
          <Text c="chatbox-tertiary">
            {t(
              'Echo Infer Desktop respects your privacy and only uploads anonymous error data and events when necessary. You can change your preferences at any time in the settings.'
            )}
          </Text>
        </Stack>
