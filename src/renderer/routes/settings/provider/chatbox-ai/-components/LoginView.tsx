        ...
        <Stack gap="xs">
          ...
          <Stack gap="0">
            <Title order={3} c="chatbox-primary">
              {t('Optional upstream account')}
            </Title>
            <Text c="chatbox-tertiary">{t('Log in only if you use the legacy upstream cloud account features')}</Text>
          </Stack>
        </Stack>
        <Stack gap="md">
        ...
        <Paper shadow="xs" p="sm" withBorder>
          <Stack gap="sm">
            <Text fw="600" c="chatbox-brand">
              {t('Optional upstream cloud features are separate from Echo Infer')}
            </Text>
            <Stack>
              {[
